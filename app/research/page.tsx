      ...
      <div className="w-full max-w-3xl space-y-6">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                {item.links.map((link, j) => (
                  <a
                    ...
                    className="rounded-lg border border-purple-400/50 bg-purple-900/60 px-3 py-1.5 text-sm text-gray-100 transition-all hover:border-purple-300 hover:bg-purple-800/70"
                  >
        ...
        <div className="rounded-xl border border-purple-400/40 bg-purple-950/80 p-6 backdrop-blur-md shadow-lg">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="rounded bg-purple-900/70 px-2 py-1 text-xs text-gray-200">Bennett Fellow</span>
            <span className="rounded bg-purple-900/70 px-2 py-1 text-xs text-gray-200">Terry Glenn Scholar</span>
            <span className="rounded bg-purple-900/70 px-2 py-1 text-xs text-gray-200">Cisco Student Success Award</span>
          </div>
        </div>
      </div>
    </PageWrapper>
